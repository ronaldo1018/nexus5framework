...
public class LocationManagerService extends ILocationManager.Stub {
	...
	private void requestLocationUpdatesLocked(LocationRequest request, Receiver receiver,
		...
		Log.d(HOWARD_TAG, "gps request " + Integer.toHexString(System.identityHashCode(receiver))
				+ " " + name + " " + request + " from " + packageName + "(" + uid + ")");
		...
		try {
			if(name.contains("gps")){
				mrm.grant(uid, MultiResourceManager.HARDWARE_GPS);
			} else if(name.contains("network")){
				mrm.grant(uid, MultiResourceManager.HARDWARE_AGPS);
			}
		} catch(Exception e) {
			e.printStackTrace();
		}
	...
	@Override
		public void reportLocation(Location location, boolean passive) {
			...
			Log.i(HOWARD_TAG, "reportLocation: " + location);
